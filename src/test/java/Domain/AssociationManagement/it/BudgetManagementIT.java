...
public class BudgetManagementIT {
    ...
    public void init() {
        ...
        g111.SignUp("gdfg","zbvcxbidan","fenway","fdgsfd","4/6/1954","fgfdssg","1234","Owner","CF");
        ...
        //coach
        Guest g11 = new Guest();
        g11.SignUp("gdfg","zbvcxbidan","klop","fdgsfd","cgfd","4/6/1954","fdgs@gmail.com","Coach","CF");
     ...
     */
    @Test
    public void testRegisterTeamToLeague(){
        ...
        Assert.assertFalse(glazerss.registerTheTeamToLeague(null));
        Assert.assertFalse(glazerss.registerTheTeamToLeague("PremierLeague"));
        try{
            glazerss.AddIncoming(1000,"tickets");
            fenwayy.AddIncoming(10000,"tickets");
            mansourrr.AddIncoming(10000,"tickets");
        }catch (Exception e){e.printStackTrace();}
        Assert.assertTrue(glazerss.registerTheTeamToLeague("PremierLeague"));
        //fenwayy.registerTheTeamToLeague("PremierLeague");
        Assert.assertTrue(fenwayy.registerTheTeamToLeague("PremierLeague"));
        //mansourrr.registerTheTeamToLeague("PremierLeague");
        Assert.assertTrue(mansourrr.registerTheTeamToLeague("PremierLeague"));
